...
class Setting:
    ...
    def __init__(self, game, menu_command: (), button_commands: list[()], **settings) -> None:
        ...
        for index, (setting, value) in enumerate(self.settings.items()):
            ...
            self.buttons.append((Button((start_x + text_sizex, start_y + (delta_y / 2) - text_sizey / 2), (button_sizex, button_sizey), [f"+", "black", text_sizey], "orange", command=button_commands[index][0]),
